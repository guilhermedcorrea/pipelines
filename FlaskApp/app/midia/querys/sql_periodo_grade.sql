...
IF OBJECT_ID('Integracao.Silver.DimFacesPaineisMidia', 'U') IS NOT NULL
BEGIN
    ...
    FROM Integracao.Silver.DimFacesPaineisMidia d
...
BEGIN
    ...
    FROM (
        ...
        SELECT
            ...
            END AS CodFaceEfetivo
        FROM Integracao.Silver.FatoOcupacaoPaineisMidia r
