...
DAG_ID_PADRAO = "pipeline_controle_contratos_midia"
...
NOME_ARQUIVO_EXCEL_CONTROLE_CONTRATOS = os.getenv(
    ...
    "Copia-Controle de Contratos Midia.xlsm",
)
...
PASTA_SHAREPOINT_CONTAINER = Path(
    os.getenv(
        ...
        "/home/midia/projetos/pipelines/airflow/01- Controle de Contratos",
    )
)
...
PASTA_CARGA_CONTAINER = Path(
    os.getenv(
        ...
        "/opt/airflow/Dados/Midia/Comercial/CargasSQL/ControleContratosMidia",
    )
)
...
mapeamento_colunas = {
    ...
    "CNPJ DA EXIBIDORA (MIDIA)": "CnpjExibibora",
...
def localizar_caminho_excel_controle_contratos() -> Path:
    ...
    raizes_busca = [
        Path("/home/midia/projetos/pipelines/airflow"),
        Path("/opt/airflow"),
...
CAMINHO_AIRFLOW_HOST_RAIZ = Path("/home/midia/projetos/pipelines/airflow")
...
def validar_caminho_visivel_no_host(caminho: Path, nome_contexto: str) -> None:
    ...
    if mount_sobreposto is not None:
        raise PermissionError(
            ...
            "/home/midia/projetos/pipelines/airflow/01- Controle de Contratos, que agora é uma raiz permitida."
        )
...
MERGE [Silver].[FatoControleContratosMidia] AS T
USING Src AS S
...
Final AS (
    SELECT
      ...
      , CAST(NULL AS INT) AS [IDFatoControleContratoMidia]
      , [NumeroContrato]
      , [NumeroPrevia]
      , [CNPJ]
      , [CodPonto]
...
Fonte AS (
    SELECT
          f.Referencia
        , MAX(f.IDFatoControleContratoMidia) AS IDFatoControleContratoMidia
...
MERGE INTO [Integracao].[Silver].[FatoControleContratosItensMidia] AS T
USING Fonte AS S
    ON T.Referencia = S.Referencia
WHEN MATCHED
    AND EXISTS
...
UPDATE ftci
SET
    ftci.IDFatoControleContratoMidia = ftc.IDFatoControleContratosMidia
FROM [Silver].[FatoControleContratosItensMidia] AS ftci
INNER JOIN [Silver].[FatoControleContratosMidia] AS ftc
    ON  ftc.NumeroContrato = ftci.NumeroContrato
    AND ftc.NumeroPrevia   = ftci.NumeroPrevia
WHERE
    ftci.IDFatoControleContratoMidia IS NULL
    OR ftci.IDFatoControleContratoMidia <> ftc.IDFatoControleContratosMidia;
"""
...
FROM [Silver].[FatoControleContratosItensMidia] AS fctti
...
FROM [Silver].[FatoControleContratosMidia] AS fct
...
UPDATE fcti
SET
      fcti.IDPainelMidia = dpie.IDDimPaineisMidia
    , fcti.DataAtualizacao = GETDATE()
FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS fcti
INNER JOIN [Integracao].[Silver].[DimPaineisMidia] AS dpie
    ON TRY_CONVERT(int, dpie.CodPonto) = TRY_CONVERT(int, fcti.CodPonto)
WHERE
    fcti.CodPonto IS NOT NULL
    AND (
        fcti.IDPainelMidia IS NULL
        OR fcti.IDPainelMidia <> dpie.IDDimPaineisMidia
    );
"""
...
SET
    ...
    , fcti.IDPainelMidia = dpe.IDDimPaineisMidia
    , fcti.DataAtualizacao = GETDATE()
FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS fcti
...
WHERE
    ...
    AND (
        ...
        OR fcti.IDPainelMidia IS NULL
        OR fcti.IDPainelMidia <> dpe.IDDimPaineisMidia
    );
"""
...
IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'ChaveOcupacaoOrigem') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [ChaveOcupacaoOrigem] varchar(100) NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'BitOcupacaoCompartilhada') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
...
IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'ReferenciaOcupacaoEmComum') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [ReferenciaOcupacaoEmComum] nvarchar(500) NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'BitOcupacaoFatiada') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
...
IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'ReferenciaAgendamento') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [ReferenciaAgendamento] varchar(300) NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'SequenciaAgendamento') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [SequenciaAgendamento] int NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'QuantidadePeriodosAgendamento') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [QuantidadePeriodosAgendamento] int NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'DataInicioTotalAgendamento') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [DataInicioTotalAgendamento] date NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'DataTerminoTotalAgendamento') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
    ADD [DataTerminoTotalAgendamento] date NULL;
END;

IF COL_LENGTH('Integracao.Silver.FatoControleContratosItensMidia', 'TipoPeriodoAgendamento') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoControleContratosItensMidia]
...
BEGIN
    ...
    (
        ...
        [IDFatoOcupacaoPaineisMidia] int NULL,
        [IDEmpresa] int NULL,
        [IDFatoControleContratosMidia] int NULL,
        [IDFatoControleContratosItensMidia] int NULL,
        [IDDimPaineisMidia] int NULL,
...
IF COL_LENGTH('Integracao.Silver.FatoVinculaMarcasOcupacao', 'IDFatoControleContratosItensMidia') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoVinculaMarcasOcupacao]
    ADD [IDFatoControleContratosItensMidia] int NULL;
END;
...
BEGIN
    ...
    (
        ...
        [IDFatoControleContratosMidia] int NOT NULL,
        [IDFatoControleContratosItensMidia] int NOT NULL,
        [IDDimPaineisMidia] int NULL,
        [IDDimFacesPaineis] int NULL,
...
IF COL_LENGTH('Integracao.Silver.FatoAgendamentoFaceContrato', 'IDFatoOcupacaoPaineisMidia') IS NULL
BEGIN
    ALTER TABLE [Integracao].[Silver].[FatoAgendamentoFaceContrato]
    ADD [IDFatoOcupacaoPaineisMidia] int NULL;
END;

IF
(
       COL_LENGTH('Integracao.Silver.FatoAgendamentoFaceContrato', 'IDFatoControleContratosMidia') IS NULL
    OR COL_LENGTH('Integracao.Silver.FatoAgendamentoFaceContrato', 'IDFatoControleContratosItensMidia') IS NULL
    OR COL_LENGTH('Integracao.Silver.FatoAgendamentoFaceContrato', 'IDDimPaineisMidia') IS NULL
    ...
    OR COL_LENGTH('Integracao.Silver.FatoAgendamentoFaceContrato', 'IDFatoOcupacaoPaineisMidia') IS NULL
...
(
    SELECT
        ...
        rn = ROW_NUMBER() OVER
        (
            PARTITION BY IDFatoControleContratosItensMidia
...
;WITH FaceResolvida AS (
    SELECT
        ...
        , IDDimPaineisMidia = MAX(IDDimPaineisMidia)
...
FonteBase AS (
    SELECT
        ...
        IDPainelMidia = COALESCE(i.IDPainelMidia, fr.IDDimPaineisMidia),
...
MERGE [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS T
...
(
    ...
    WHERE IDFatoControleContratosItensMidia IS NOT NULL
)
...
(
    SELECT
        ...
        IDDimPaineisMidia = COALESCE(
            i.IDPainelMidia,
            face_resolvida.IDDimPaineisMidia,
            painel_resolvido.IDDimPaineisMidia
        ),
    ...
    FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS i
    INNER JOIN [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS o
    ...
    (
        SELECT TOP (1)
            p.IDDimPaineisMidia
        FROM [Integracao].[Silver].[DimPaineisMidia] AS p
...
USING Fonte AS S
    ON T.IDFatoOcupacaoPaineisMidia = S.IDFatoOcupacaoPaineisMidia
   AND T.IDFatoControleContratosItensMidia = S.IDFatoControleContratosItensMidia
WHEN MATCHED THEN
    UPDATE SET
        T.IDEmpresa = S.IDEmpresa,
        T.IDFatoControleContratosMidia = S.IDFatoControleContratosMidia,
        T.IDDimPaineisMidia = S.IDDimPaineisMidia,
...
WHEN NOT MATCHED BY TARGET THEN
    ...
    VALUES
    (
        S.IDFatoOcupacaoPaineisMidia,
        S.IDEmpresa,
        S.IDFatoControleContratosMidia,
        S.IDFatoControleContratosItensMidia,
        S.IDDimPaineisMidia,
        S.IDDimFacesPaineis,
...
INNER JOIN [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS ocupacao
    ON ocupacao.IDFatoOcupacaoPaineisMidia = vinculo.IDFatoOcupacaoPaineisMidia
WHERE
    ...
    (
        ...
        FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS item
        WHERE
            item.IDFatoControleContratosItensMidia = vinculo.IDFatoControleContratosItensMidia
...
SET
    ocupacao.BitEmpresasRelacionadas = CASE
        ...
        (
            SELECT 1
            FROM [Integracao].[Silver].[FatoVinculaMarcasOcupacao] AS vinculo
            WHERE vinculo.IDFatoOcupacaoPaineisMidia = ocupacao.IDFatoOcupacaoPaineisMidia
        ) THEN 1
        ELSE 0
    END,
    ocupacao.DataAtualizacao = CAST(GETDATE() AS datetime2(0))
FROM [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS ocupacao
...
(
    ...
    FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS i
    LEFT JOIN [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS ocupacao
    ...
    HAVING COUNT(DISTINCT ocupacao.IDFatoOcupacaoPaineisMidia) <> 1
)
BEGIN
...
(
    SELECT
        IDFatoControleContratosMidia = i.IDFatoControleContratoMidia,
        IDFatoControleContratosItensMidia = i.IDFatoControleContratosItensMidia,
        IDDimPaineisMidia = i.IDPainelMidia,
        IDDimFacesPaineis = i.IDDimFacesPaineis,
        IDFatoVinculaMarcasOcupacao = CAST(NULL AS int),
        IDFatoOcupacaoPaineisMidia = ocupacao.IDFatoOcupacaoPaineisMidia,
        ...
        rn = ROW_NUMBER() OVER
        (
            PARTITION BY i.IDFatoControleContratosItensMidia
            ORDER BY i.DataAtualizacao DESC, i.IDFatoControleContratosItensMidia DESC
        )
    FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS i
    INNER JOIN [Integracao].[Silver].[FatoControleContratosMidia] AS c
        ON c.IDFatoControleContratosMidia = i.IDFatoControleContratoMidia
    INNER JOIN [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS ocupacao
        ON ocupacao.Referencia = i.ReferenciaAgendamento
       AND ocupacao.Origem = 'CONTRATO'
...
USING Fonte AS S
    ON T.IDFatoControleContratosItensMidia = S.IDFatoControleContratosItensMidia
   AND T.BitAtivo = 1
WHEN MATCHED THEN
    UPDATE SET
        T.IDFatoControleContratosMidia = S.IDFatoControleContratosMidia,
        ...
        T.IDFatoOcupacaoPaineisMidia = S.IDFatoOcupacaoPaineisMidia,
        T.IDEmpresa = S.IDEmpresa,
        T.Marca = S.Marca,
        T.Previa = S.Previa,
...
WHERE
    ...
    (
        ...
        FROM [Integracao].[Silver].[FatoControleContratosItensMidia] AS item
        WHERE
            item.IDFatoControleContratosItensMidia = agendamento.IDFatoControleContratosItensMidia
...
(
    ...
    INNER JOIN [Integracao].[Silver].[FatoVinculaMarcasOcupacao] AS vinculo
        ON vinculo.IDFatoControleContratosItensMidia = agendamento.IDFatoControleContratosItensMidia
...
(
    ...
    FROM [Integracao].[Silver].[FatoAgendamentoFaceContrato] AS agendamento
    LEFT JOIN [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS ocupacao
        ON ocupacao.IDFatoOcupacaoPaineisMidia = agendamento.IDFatoOcupacaoPaineisMidia
    WHERE
        agendamento.BitAtivo = 1
        AND agendamento.Referencia LIKE 'FAT-%'
        AND
        (
            agendamento.IDFatoOcupacaoPaineisMidia IS NULL
            OR ocupacao.IDFatoOcupacaoPaineisMidia IS NULL
...
@dag(
    ...
    catchup=False,
    max_active_runs=1,
    tags=["Midia", "ETL", "Controle de Contratos"],
    description=(
...
`/root/PythonJobs/pipelines/airflow/Dados/SharePoint/BaseDados/Base Dados - 01- Controle de Contratos/Copia-Controle de Contratos Midia.xlsm`
...
### Silver
- `Silver.FatoControleContratosMidia`
- `Silver.FatoControleContratosItensMidia`
- `Silver.FatoOcupacaoPaineisMidia`
...
A tabela `Silver.FatoControleContratosMidia` recebe uma visão agregada por referência contratual.

### 8. Consolidação dos itens
A tabela `Silver.FatoControleContratosItensMidia` recebe a granularidade detalhada por item.
...
- executa MERGE de ocupação em `FatoOcupacaoPaineisMidia`;
...
```json
{
  ...
  "tabela_origem": "[Integracao].[Silver].[FatoOcupacaoPaineisMidia]"
}
```
...
def pipeline_controle_contratos_midia():
    ...
    def garantir_estrutura_relacionamentos_ocupacao() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            destino_dados=(
                "[Integracao].[Silver].[FatoControleContratosItensMidia] + "
    ...
    def merge_contratos() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            descricao_etapa=(
                "Consolida a visão agregada de contratos na tabela Silver.FatoControleContratosMidia, "
            ...
            sql_amostra="""
                SELECT TOP 5
                    ...
                    TotalFaturamentoLiquidoMensal,
                    DataAtualizacao
                FROM [Silver].[FatoControleContratosMidia]
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados=TABELA_STAGE,
            destino_dados="[Silver].[FatoControleContratosMidia]",
        )
    ...
    def merge_itens() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            descricao_etapa=(
                ...
                "alimentando a tabela Silver.FatoControleContratosItensMidia."
            ),
            ...
            sql_amostra="""
                SELECT TOP 5
                    ...
                    TipoPeriodoAgendamento,
                    DataAtualizacao
                FROM [Silver].[FatoControleContratosItensMidia]
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados=TABELA_STAGE,
            destino_dados="[Silver].[FatoControleContratosItensMidia]",
        )
    ...
    def update_fk_contratos_itens() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            sql_amostra="""
                ...
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados="[Silver].[FatoControleContratosMidia] + [Silver].[FatoControleContratosItensMidia]",
            destino_dados="[Silver].[FatoControleContratosItensMidia]",
        )
    ...
    def update_id_vendedor() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            sql_amostra="""
                ...
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados="[Silver].[FatoControleContratosItensMidia] + [Integracao].[dbo].[Vendedores]",
            destino_dados="[Silver].[FatoControleContratosItensMidia]",
        )
    ...
    def update_id_empresa() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            sql_amostra="""
                ...
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados="[Silver].[FatoControleContratosMidia] + [Integracao].[Silver].[DimEmpresas]",
            destino_dados="[Silver].[FatoControleContratosMidia]",
        )
        ...
        return executar_sql_auditado(
            ...
            sql_amostra="""
                SELECT TOP 5
                    ...
                    DataAtualizacao
                FROM [Integracao].[Silver].[FatoControleContratosItensMidia]
                WHERE IDPainelMidia IS NOT NULL
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados="[Integracao].[Silver].[FatoControleContratosItensMidia] + [Integracao].[Silver].[DimPaineisMidia]",
            destino_dados="[Integracao].[Silver].[FatoControleContratosItensMidia]",
        )
    ...
    def update_id_face() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            sql_amostra="""
                ...
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados="[Integracao].[Silver].[FatoControleContratosItensMidia] + [Integracao].[Silver].[DimFacesPaineis]",
            destino_dados="[Integracao].[Silver].[FatoControleContratosItensMidia]",
        )
        ...
        return executar_sql_auditado(
            ...
            sql_amostra="""
                SELECT TOP 5
                    ...
                    TipoVinculoOrigem,
                    DataAtualizacao
                FROM [Integracao].[Silver].[FatoOcupacaoPaineisMidia]
                ORDER BY DataAtualizacao DESC, Referencia DESC
            """,
            origem_dados="[Integracao].[Silver].[FatoControleContratosItensMidia]",
            destino_dados="[Integracao].[Silver].[FatoOcupacaoPaineisMidia]",
        )
    ...
    def upsert_vinculos_marcas_ocupacao() -> dict[str, Any]:
        return executar_sql_auditado(
            ...
            sql_amostra="""
                ...
                INNER JOIN [Integracao].[Silver].[FatoOcupacaoPaineisMidia] AS o
                    ON o.IDFatoOcupacaoPaineisMidia = v.IDFatoOcupacaoPaineisMidia
            ...
            origem_dados=(
                ...
                "[Integracao].[Silver].[DimPaineisMidia] + "
...
dag = pipeline_controle_contratos_midia()
